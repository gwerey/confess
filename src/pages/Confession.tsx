...
export const Confession = () => {
  ...
  const to = "Rayya";
  const from = "Adi"; 
  const message = "Rayya, sebenernya aku suka banget sama kamu. Kamu itu orangnya baik, manis, imut, lucu, gemesin, dan selalu bikin hari-hariku lebih berwarna WELL. Aku pengen kita bisa lebih dari sekadar teman. Maukah kamu jadi pacarku?";
